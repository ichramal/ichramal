...
svg = f'''<svg width="400" height="560" viewBox="0 0 400 560" xmlns="http://www.w3.org/2000/svg" aria-labelledby="cardTitle" role="img">
  ...
  <text x="200" y="30" text-anchor="middle" font-family="Arial,sans-serif" font-size="13" font-weight="bold" fill="#ffffff">Spotify</text>
  ...
  <text x="200" y="485" text-anchor="middle" font-family="Arial,sans-serif" font-size="15" fill="#b3b3b3">Tame Impala</text>
  <rect x="110" y="510" width="180" height="36" rx="18" fill="#1DB954"/>
  <polygon points="147,520 147,536 159,528" fill="#ffffff"/>
  <text x="165" y="532" font-family="Arial,sans-serif" font-size="12" font-weight="bold" fill="#ffffff">PLAY ON SPOTIFY</text>
